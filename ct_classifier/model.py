...
class CustomResNet101(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.feature_extractor = resnet.resnet101(pretrained=True)       # "pretrained": use weights pre-trained on ImageNet
...
class CustomResNet152(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.feature_extractor = resnet.resnet152(pretrained=True)       # "pretrained": use weights pre-trained on ImageNet
